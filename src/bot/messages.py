...
MESSAGES: dict[str, MessageConfig] = {
    ...
    "choose_package_self": MessageConfig(
        ...
        text=(
            "Твоё демо <b>Портрета личности</b> — в закреплённом файле выше "
            "<tg-emoji emoji-id=\"5370688099196101085\">📁</tg-emoji> "
            "Открой его: первые разделы уже расшифрованы.\n\n"
            "Внутри остались закрытыми:\n"
            "🔒 Число жизненного пути · инсайты Матрицы судьбы — <b>Базовый</b>\n"
            "🔒 Ошибка, которая тормозит жизнь · Скрытый талант · Кармический урок — <b>Расширенный</b>\n"
            "🔒 Сценарий в отношениях · Ключевые периоды жизни · Скрытая правда — <b>Премиум</b>\n\n"
            "Выбери пакет — и я открою их:"
        ),
    ...
    "choose_package_money": MessageConfig(
        ...
        text=(
            "Твоё демо <b>Денежной карты</b> — в закреплённом файле выше "
            "<tg-emoji emoji-id=\"5370688099196101085\">📁</tg-emoji> "
            "Открой его: первые разделы уже расшифрованы.\n\n"
            "Внутри остались закрытыми:\n"
            "🔒 Главная причина проблем с деньгами · Денежный код · Финансовый прогноз — <b>Базовый</b>\n"
            "🔒 Денежный потолок · Стратегия заработка — <b>Расширенный</b>\n"
            "🔒 Деньги по ладони · Финансовый якорь · Момент смены работы — <b>Премиум</b>\n\n"
            "Выбери пакет — и я открою их:"
        ),
    ...
    "choose_package_couple": MessageConfig(
        ...
        text=(
            "Ваше демо <b>Совместимости пары</b> — в закреплённом файле выше "
            "<tg-emoji emoji-id=\"5370688099196101085\">📁</tg-emoji> "
            "Открой его: первые разделы уже расшифрованы.\n\n"
            "Внутри остались закрытыми:\n"
            "🔒 Анализ совместимости · Верность · Перспектива брака — <b>Базовый</b>\n"
            "🔒 Точка разрыва · Семья и родительство · Восприятие друг друга — <b>Расширенный</b>\n"
            "🔒 Длительность союза · Сексуальная совместимость · Хиромантия пары — <b>Премиум</b>\n\n"
            "Выбери пакет — и я открою их:"
        ),
        photos=["couple/all.jpeg"]
    ),
    # Версии для уже купивших (апгрейд после платного отчёта или из меню):
    # тизер про «демо в файле выше» тут не подходит
    "choose_package_self_paid": MessageConfig(
        key="choose_package_self_paid",
        text="Открыть <b>Портрет личности</b> ещё глубже — выбери пакет:",
        photos=["self/all.jpeg"]
    ),
    "choose_package_money_paid": MessageConfig(
        key="choose_package_money_paid",
        text="Открыть <b>Денежную карту</b> ещё глубже — выбери пакет:",
        photos=["money/all.jpeg"]
    ),
    "choose_package_couple_paid": MessageConfig(
        key="choose_package_couple_paid",
        text="Открыть <b>Совместимость пары</b> ещё глубже — выбери пакет:",
        photos=["couple/all.jpeg"]
    ),
    ...
    "reset_done": MessageConfig(
        key="reset_done",
        text=(
            "<tg-emoji emoji-id=\"5451651836203264085\">✔️</tg-emoji> <b>Данные сброшены</b>\n\n"
