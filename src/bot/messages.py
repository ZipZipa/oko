...
<b>Для начала, напиши свое имя</b> <tg-emoji emoji-id="5348460861755262251">✍️</tg-emoji>",
    ...
    "photo_received": MessageConfig(
        key="photo_received",
        text="<tg-emoji emoji-id="5379965177015846816">🔑</tg-emoji> <b>Твоё фото - это ключ к разбору</b>
...
Выбери, что хочешь посмотреть:",
    ...
    "self_intro": MessageConfig(
        key="self_intro",
        text="<tg-emoji emoji-id="5237948187838262194">👁️</tg-emoji> <b>Анализ личности</b> - это глубокий анализ твоей внешности, психологических паттернов и скрытых особенностей, о которых ты даже не догадываешься 
...
Запустим тестовый анализ?",
    ...
    "money_intro": MessageConfig(
        key="money_intro",
        text="<tg-emoji emoji-id="5366543795057881388">🤑</tg-emoji> <b>Денежный потенциал</b> - разбор того, как ты привлекаешь деньги, где теряешь ресурсы и твои скрытые точки роста
...
Запустим тестовый анализ?",
    ...
    "couple_intro": MessageConfig(
        key="couple_intro",
        text=<tg-emoji emoji-id="5363887035662758185">❤️</tg-emoji> "<b>Совместимость пары</b> - разбор вашей динамики отношений, матриц, верности и кармы, а так же потенциал вашего союза и скрытых сторон партнера, о которых ты можешь не догадываться  
...
Запустим тестовый анализ?",
    ...
    "partner_photo_request": MessageConfig(
        ...
        text="Отлично! Теперь пришли фото партнёра <tg-emoji emoji-id="5395698544164233115">🤩</tg-emoji>\n\n"
    ...
    "palm_needed_self": MessageConfig(
        ...
        text="<tg-emoji emoji-id="5262912590756982214">👋</tg-emoji> <b>Ладони хранят больше информации, чем кажется</b> 
...
Начнём с <b>левой ладони</b> - пришли фото ладонью вверх (линии должны быть чётко видны)",
    ...
    "palm_needed_money": MessageConfig(
        ...
        text="<tg-emoji emoji-id="5262912590756982214">👋</tg-emoji> <b>Линии ладоней могут показать, как ты взаимодействуешь с деньгами</b>
...
Для <b>премиум анализа</b> пришли фото <b>левой ладони</b> - ладонью вверх (линии должны быть чётко видны)\n"
    ...
    "palm_not_detected": MessageConfig(
        ...
        text="<tg-emoji emoji-id="5805364370376496031">😎</tg-emoji>Не удалось распознать линии ладони

Попробуй отправить другое фото - ладонь должна быть направлена вверх, хорошее освещение, линии должно быть чётко видны.",
    ),
    "palm_left_accepted": MessageConfig(
        key="palm_left_accepted",
        text="<b>Получил!</b> <tg-emoji emoji-id="5395526217191416774">🤩</tg-emoji>\n\n"
    ...
    "palm_both_accepted": MessageConfig(
        ...
        text="<tg-emoji emoji-id="5222154218701352505">✔️</tg-emoji>Линии ладоней успешно считаны
