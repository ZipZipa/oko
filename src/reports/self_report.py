...
- line_patterns — жизненная линия, голова, сердце, судьба: поля depth, length, curvature, branching, nuances
- key_line_pattern — какая линия выделяется на фоне остальных и её интерпретация
- element_type — стихия руки (earth/air/water/fire), palm_shape, avg_finger_length
- dominant_finger — доминирующий палец и его тема; thumb_angle — угол раскрыва большого пальца
- ratio_2d4d — соотношение указательного к безымянному пальцу и психологическая интерпретация
- spread_and_curvature — растопыренность пар пальцев и кривизна каждого пальца
- skin_contrast — контраст текстуры ладони и лица (внутреннее состояние vs внешнее)
...
- line_observations — по одному пункту на каждую линию, используй depth/curvature/branching из line_patterns
...
- Оцени ухоженность и стиль на основе face_data (accessories, skin, hair)
- Ссылайся на scores.grooming и stylistic_markers из face_signals
...
- hand_analysis → hand_signals.element_type, hand_signals.dominant_finger, hand_signals.ratio_2d4d, hand_signals.spread_and_curvature, hand_signals.line_patterns
- deep_portrait.block_2_hiromantia → hand_signals.line_patterns, hand_signals.key_line_pattern, hand_signals.element_type
- grooming_and_style → grooming_signals (skin_condition, tension_zones, accessories, skin_contrast, grooming_score, skin_score)
