...
- Дети — оцени по нумерологии и матрице, не предсказывай пол/количество
- Карма — описывай уроки пары, не "прошлые жизни" с конкретикой
- Пинакли и годы брака — возраста пинаклей (age_start/age_end) АБСОЛЮТНЫЕ (возраст человека), а годы в marriage_perspective ОТНОСИТЕЛЬНЫЕ (годы отношений). Ты НЕ ЗНАЕШЬ дату начала брака. НЕ привязывай пинакли к годам брака — НЕ пиши «у N начинается пинакль X на Y-м году» или «пинакль совпадает с кризисом Z-го года». Это галлюцинация.
...
REQUIRED_STRUCTURE = {
    ...
    "wealth": ["intro_quote", "level", "points", "money_pattern",
               "blocking_factors"],
    "children": ["intro_quote", "potential_level", "points", "timing"],
